...
#Para as conclusões, os autores do artigo citado utilizaram variáveis como: 
#'species of animal'
#'body weight in kg', 
#'brain weight in g', 
#'slow wave ("nondreaming") 
#sleep (hrs/day) 
...
#'overall danger index (1-5) (based on the above two indices and other information) 1 = least danger (from other animals) 5 '.
#Todas essas variáveis estão adequadamente explicadas na sessão "README.md"
...
#Utilização do "dtpes" para observar os tipos(int, float, str):
dtsleep.dtypes
